...
namespace BusinessObject.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<bool> LoginAdmin(string email, string password, CancellationToken cancellationToken = default)
        {
            await Task.CompletedTask;
            var isAdmin = _members.Any(member => member.Role.Equals("admin") && member.Email.Equals(email) && _passwordHasher.VerifyPassword(password, member.Password));
        ...
        public bool IsAdmin() => CurrentMember!=null && ((CurrentMember.Email.Equals("admin@gmail.com") && CurrentMember.Password.Equals("admin@@")) 
            || (CurrentMember.Email.Equals("admin2@gmail.com") && CurrentMember.Password.Equals("admin2@@")));
    }
}
